...
def usage():
	...
	print
	print "Examples "
	print "nc.py -t 192.168.0.1 -p 55555 -l -c"
	print "nc.py -t 192.168.0.1 -p 55555 -l -u=c:\\target.exe"
	print "nc.py -t 192.168.0.1 -p 55555 -l -e=\"cat /etc/passwd\""
...
def main():
	...
	try: 
		opts, args = getopt.getopt(sys.argv[1:], "hle:t:p:cu:",
			["help", "listen", "execute", "target", "post", "command", "upload"])
